...
A continuación, se presenta un ejemplo práctico que combina varios paquetes para realizar un análisis de estadístico de datos:
...
Se utiliza el paquete `readxl` para importar un archivo Excel con los datos de altura de las parcelas de pino.
